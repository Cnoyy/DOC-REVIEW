...
- Name: auth.spec.ts >> Authentication >> should protect library route - redirect to 404 when not authenticated
...
Received: "http://localhost:3000/dashboard/library"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    8 × unexpected value "http://localhost:3000/dashboard/library"
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e8]:
      - link "Sign In to Continue" [ref=e9]:
        - /url: /Auth/Login
      - link "Go to Homepage" [ref=e10]:
        - /url: /
