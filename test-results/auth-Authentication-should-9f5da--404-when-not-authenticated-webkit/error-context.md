...
- Name: auth.spec.ts >> Authentication >> should protect account route - redirect to 404 when not authenticated
...
Received: "http://localhost:3000/dashboard/account"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    8 × unexpected value "http://localhost:3000/dashboard/account"
